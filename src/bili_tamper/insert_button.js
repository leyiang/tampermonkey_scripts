import { listenForDOM, newButtonNode, parseTime, slog, newEl} from "../utils/utils";
...
export function insertButton() {
	...
	listenForDOM(".conditions-order .search-condition-row", wrap => {
        ...
        const btn = newEl(`<button class="vui_button vui_button--tab ${is_24_search_rule() ? "vui_button--active" : ""} mr_sm">24小时最多播放</button>`);
        wrap.appendChild( btn );
        ...
        const btn_a = newEl(`<button class="vui_button vui_button--tab mr_sm">清除排序</button>`);
